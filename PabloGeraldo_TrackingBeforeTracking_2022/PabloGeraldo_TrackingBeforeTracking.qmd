...
<br>
Between 40 and 50% of students follow the vocational track:
...
<br>
Current research on horizontal stratification:
...
<br>
Exploit the decoupling between institutional and curricular setting

* How does attending a vocational school affects
...
The main problem one faces when trying to identify causal relationships with observational data: **maybe students in general and vocational schools are not comparable!**
...
<br>
My findings generally support the hypotheses of a negative impact of attending TVET schools, **net of curricular differentiation**, on:
...
<br>
As expected in an observational study, there are several limitations to this study:
